...
extension GroupQueryFilter on QueryBuilder<Group, Group, QFilterCondition> {
  ...
  QueryBuilder<Group, Group, QAfterFilterCondition> parentFolderIdIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Group, Group, QAfterFilterCondition> parentFolderIdIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Group, Group, QAfterFilterCondition> parentFolderIdEqualTo(
      int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'parentFolderId',
  ...
  QueryBuilder<Group, Group, QAfterFilterCondition> parentFolderIdGreaterThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Group, Group, QAfterFilterCondition> parentFolderIdLessThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Group, Group, QAfterFilterCondition> parentFolderIdBetween(
    int? lower,
    int? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension GroupQuerySortBy on QueryBuilder<Group, Group, QSortBy> {
  ...
  QueryBuilder<Group, Group, QAfterSortBy> sortByParentFolderId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'parentFolderId', Sort.asc);
    });
  }

  QueryBuilder<Group, Group, QAfterSortBy> sortByParentFolderIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension GroupQuerySortThenBy on QueryBuilder<Group, Group, QSortThenBy> {
  ...
  QueryBuilder<Group, Group, QAfterSortBy> thenByParentFolderId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'parentFolderId', Sort.asc);
    });
  }

  QueryBuilder<Group, Group, QAfterSortBy> thenByParentFolderIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'parentFolderId', Sort.desc);
    });
  }
...
extension GroupQueryWhereDistinct on QueryBuilder<Group, Group, QDistinct> {
  ...
  QueryBuilder<Group, Group, QDistinct> distinctByParentFolderId() {
    return QueryBuilder.apply(this, (query) {
...
extension GroupQueryProperty on QueryBuilder<Group, Group, QQueryProperty> {
  ...
  QueryBuilder<Group, int?, QQueryOperations> parentFolderIdProperty() {
    return QueryBuilder.apply(this, (query) {
